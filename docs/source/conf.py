...
latex_documents = [
    (master_doc, "trmsfkit.tex", "tRMSF Documentation",
     "trmsfkit", "manual"),
]
...
man_pages = [
    (master_doc, "trmsfkit", "tRMSF Documentation",
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, "trmsfkit", "tRMSF Documentation",
     author, "trmsfkit", "A package to perform time-dependent RMSF analysis on molecular dynamics data.",
     "Miscellaneous"),
]
