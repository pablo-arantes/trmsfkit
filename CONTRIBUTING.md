...
We welcome all contributions to tRMSF!

Contributions can take many forms, such as:

* sharing bug reports or feature requests through the [Issue Tracker](https://github.com/pablo-arantes/trmsfkit/issues)
...
The second two options both involve making a [pull request](https://github.com/pablo-arantes/trmsfkit/pulls) .
